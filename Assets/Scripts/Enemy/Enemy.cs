...
public class Enemy : MonoBehaviour, ISaveable
{
    ...
    public void OnCreated(GameManager a_GameManager)
    {
    ...
    public void PopulateSaveData(SaveData a_SaveData)
    {
        ...
        enemyData.m_Health = m_CurrentHealth;
        enemyData.m_Id = gameObject.GetInstanceID();
    ...
    public void LoadFromSaveData(SaveData a_SaveData)
    {
        ...
        {
            if (enemyData.m_Id == gameObject.GetInstanceID())
            {
                m_CurrentHealth = enemyData.m_Health;
                break;
            }
        }
